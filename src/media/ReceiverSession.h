...
private:
    ...
    static GstPadProbeReturn on_encoded_input_probe(GstPad* pad, GstPadProbeInfo* info, gpointer user_data);
    static GstPadProbeReturn on_decoded_input_probe(GstPad* pad, GstPadProbeInfo* info, gpointer user_data);
    static GstPadProbeReturn on_display_output_probe(GstPad* pad, GstPadProbeInfo* info, gpointer user_data);
    ...
    void enter_damage_free_mode(const char* reason);
    ...
    std::uint64_t displayed_frame_count_ = 0;
    ...
    bool recovery_keyframe_accepted_ = false;
    bool keyframe_only_mode_ = false;
    bool drop_next_idr_after_loss_ = false;
    std::int64_t last_clean_main_frame_ms_ = 0;
